export const textNodes = [
    {
        ...
        text: `<h1>Day 1</h1><p>“You wake lying on your back, staring up into a ceiling of branches. You sit up and find yourself in a forest, alone. Half buried in the leaves beside you is a long sword. On closer inspection, the blade is free of all markings, save the hilt, where a human face is wrought in silver, expression inscrutable. You have no memory of where you are or how you came here. There’s a river nearby: you can hear it off to your left. You stand and notice a ridge of stone in the distance that wasn’t visible from the ground.</p>
        <p><em>There must be something here to tell me where I am.<br>I just need to get my bearings.</em></p>
